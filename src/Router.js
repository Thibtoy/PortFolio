export default class Router {
	...
	init() {
		...
		window.addEventListener('urlChange', function(event) {//On ajoute une fonction pour ce qu'il se passe lors du changement d'url;
			that.parent.render();//On demande à notre app de se re-render;
		}, false);

		window.onpopstate = function() {//On ajoute une fonction sur une action utilisateur de type 'suivant' ou 'précèdent';
			that.parent.render();//On demande à notre app de se re-render;
		};
	}
